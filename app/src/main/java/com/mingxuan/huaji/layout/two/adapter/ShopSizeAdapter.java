...
public class ShopSizeAdapter extends RecyclerView.Adapter<ShopSizeAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(isClicks.get(position)){
            ...
            holder.size.setBackground(context.getResources().getDrawable(R.drawable.size_red));
        }else{
            holder.size.setTextColor(context.getResources().getColor(R.color.transparent80));
            holder.size.setBackground(context.getResources().getDrawable(R.drawable.size_black));
        }
